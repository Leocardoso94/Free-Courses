			...
			<ReactCSSTransitionGroup
				...
				className="contribute">
					...
					{this.state.contributors.map(contributor => {
						return <a target="_blank" rel="noopener noreferrer" href={contributor.html_url} style={{ marginRight: "5px", display: 'inline-block', padding: '5px' }} key={contributor.login}>@{contributor.login}</a>;
					})}
