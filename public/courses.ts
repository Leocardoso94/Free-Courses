...
const courses: Course[] = [
  ...
  {
    title: "React ile Proje Geliştirmek",
    description: "Bu kurs sıfırdan ReactJs anlatmaktadır. Tayfun Erbilen tarafından prototürk.com için hazırlanmıştır.",
    link: "https://www.youtube.com/watch?v=slVS7QNsSk8&list=PLfAfrKyDRWrGXWpnJdyC4yXIW6v-PcFu-",
  ...
  {
    title: "Temelden Zirveye Flutter",
    description: "Bu kurs temelden zirveye flutter anlatmaktadır. Flutter best practices olarak yazmak isteyenlerin aradığı kurs.",
    link: "https://www.youtube.com/watch?v=lpvuM9lo3HU&list=PL1k5oWAuBhgXdw1BbxVGxxWRmkGB1C11l",
    author: "Veli Bacık",
    level: "Intermediate - Advanced",
    categories: "Flutter",
    language: "Turkish",
    flags: "flag-icon-tr",
    image: "https://i.ytimg.com/vi/laSlXorExj4/maxresdefault.jpg",
  },
]
  .map((course) => {
    return {
