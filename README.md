...
- [Curso CSS3 com Sass e Compass](https://www.youtube.com/watch?v=D9OpSGViDgA&list=PL3C05B7A66AC502CF)
...
- [Curso de Materialize CSS](https://www.youtube.com/watch?v=khT9AyUuLOs&list=PLwXQLZ3FdTVGJxKF3ShplF8nMuuxldlEk)
...
- [DotNET Free courses](https://www.asp.net/freecourses)
...
- [Git I](http://progate.com/languages/git)
...
- [Learn to Code](https://greatercommons.com/cwg)
...
- [Social Network](https://www.codecourse.com/lessons/social-network)
...
- [Vue JS 2.0 - Mastering Web Apps](https://www.udemy.com/vue-web-apps/?couponCode=GOHACKERS&pmtag=CTBO1202&siteID=MhbOGzq4cI4-kW.oXEWO9ehhdCszMpyOUw&LSNPUBID=MhbOGzq4cI4)
...
- [Laravel Tutorial](https://www.tutorialspoint.com/laravel/)
...
- [Try Laravel](https://www.codeschool.com/courses/try-laravel)
...
- [Programming, Data Structures and Algorithms in Python](http://nptel.ac.in/courses/106106145/)
...
- [Python School](http://pythonschool.net/)
...
- [Python tutorials step by step](http://www.techbeamers.com/python-tutorial-step-by-step)
...
- [Ruby on Rails para iniciantes](https://www.youtube.com/playlist?list=PLe3LRfCs4go-mkvHRMSXEOG-HDbzesyaP)

	- Playlist do Curso de Ruby on Rails para Iniciantes

### React

- [Getting Started with React](https://scotch.io/courses/getting-started-with-react)
...
- [React 16 Definitivo](https://www.udemy.com/react-16/)

	- Tudo o que você precisa saber sobre a versão 16 do React

- [React Foundation](https://node.university/p/react-foundation)
...
- [React-fundamentals - Start Learning React](https://egghead.io/courses/react-fundamentals)
...
- [Swift - The Ultimate Guide To Mac and iOS Development](https://www.udemy.com/swift-ios-mac/?couponCode=SWIFT_FREE&siteID=UeOSfRUOS3E-gGVwlTaKcegJYuXJhwOQjQ&LSNPUBID=UeOSfRUOS3E)

	- Learn how to use Swift, a language that is created by the world's largest company 'Apple'.

- [Swift 3 and Xcode 8](https://www.youtube.com/watch?v=ilQ-tq772VI&list=PLPA-ayBrweUz32NSgNZdl0_QISw-f12Ai)
...
- [Vue JS - Hexschool](https://quip.com/N3iKAEDJEVmD)
